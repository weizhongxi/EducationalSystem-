...
<html lang="zh-CN">
  <head>
    ...
    <link href="${ctxStatic}/evalue/css/Style.css" type="text/css" rel="stylesheet">
  ...
  ${result}
<form name="importForm" method="post" action="/DeviceController/doImport.html" enctype="multipart/form-data">
      <br>
