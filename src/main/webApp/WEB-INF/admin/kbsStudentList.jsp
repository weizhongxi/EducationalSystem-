...
<div class="bg">
    <div class="input_souw">
        <div class="inpu_tt">首页 > 角色管理 > 学生管理</div>
...
<div class="bg">
    ...
    <div class="bg_rx">
        ...
        <div class="bg_right">
            <div class="bg_mb">
                <div class="js_ksgl">
                    <form:form id="searchForm" modelAttribute="kbsStudent" action="${ctx}/ksanalysis/kbsStudent/studentList" method="post" class="dynamic-form form-horizontal form-horizontal   form-horizontal_tt">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <form:input path="ksName" htmlEscape="false" maxlength="64" class="form-control" placeholder="输入" />
                            </div>
                            <label class="col-sm-1 control-label">专业</label>
                            <div class="col-sm-3">
                                <form:input path="" htmlEscape="false" maxlength="64" class="form-control"    placeholder="请输入" />
                            </div>
                            <label class="col-sm-1 control-label">学号</label>
                            <div class="col-sm-3">
                                <form:input path="ksStudentNumber" htmlEscape="false" maxlength="64" class="form-control" placeholder="输入" />
                            </div>
            ...
            <table class="h_table" width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <c:forEach items="${students}" var="stu">
                    <tr class="ng-scope">
                        ...
                        <td class="color_cheng w_230" ><a href="javascript:;" onclick="iopen('添加学生','.xgmm','800')">重置密码</a><span class="feng_x">|</span><a href="javascript:;" onclick="iopen('添加学生','.xgmm','800')">修改</a>
                        </td>
            ...
            <%--</button>--%>
            <button onclick="iopen('添加学生','#tongxunlu','800')" class="btn btn-warning pull-right mr20">
                添加学生
            </button>
