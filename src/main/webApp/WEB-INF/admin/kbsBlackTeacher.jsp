...
<div class="bg">
    <div class="input_souw">
        <div class="inpu_tt">首页 > 黑名单 > 教师管理</div>
    ...
    <div class="bg_rx">
        <div class="bg_left">
            ...
            <div class="bg_left_c">
                <ul>
                    ...
                    <li><a href="/index/admin/goToBlackStu.html">学生</a></li>
                    <li class="color_cheng"><a href="/index/admin/goToBackTea.html">教师</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg_right">
            ...
            <table class="h_table" width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                <c:forEach items="${blackTeachers}" var="tea">
                    <tr>
                        ...
                        <td class="color_cheng w_230" >
                            <a href="/index/admin/laBaiTeacher.html?id=${tea.teacherID}">拉白</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
