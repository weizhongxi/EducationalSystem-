...
<%@ attribute name="systemid" type="java.lang.String" required="true" description="所属系统id"%>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		// 正常打开	
		top.$.jBox.open("iframe:${ctadmin}/tag/treeselect?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}&systemid=${systemid}", "选择${title}", 300, 420, {
